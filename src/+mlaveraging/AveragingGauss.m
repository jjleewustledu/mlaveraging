classdef AveragingGauss < mlaveraging.AveragingStrategy 
	%% AVERAGINGGAUSS is a place-holder for AveragingStrstegy for the case of Gaussian averaging
	%  Version $Revision: 2584 $ was created $Date: 2013-08-29 02:59:11 -0500 (Thu, 29 Aug 2013) $ by $Author: jjlee $,  
 	%  last modified $LastChangedDate: 2013-08-29 02:59:11 -0500 (Thu, 29 Aug 2013) $ and checked into svn repository $URL: file:///Users/jjlee/Library/SVNRepository_2012sep1/mpackages/mlaveraging/src/+mlaveraging/trunk/AveragingGauss.m $ 
    ...
    methods (Static) %% legacy
        function out   = makeBlurred(in, blr)
            ...
            %
            import mlfourd.*;         
            iniib = NiiBrowser.load(imcast(in, 'fqfilename'));
            iniib = iniib.append_fileprefix(mlaveraging.AveragingGauss.blurSuffix(blr));
